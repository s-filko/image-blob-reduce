...
var pica = createCommonjsModule(function (module, exports) {
  (function (f) {
    ...
    return (function () {
      var cjr = 'function' == typeof commonjsRequire && commonjsRequire;
      function r(e, n, t) {
        function o(i, f) {
          if (!n[i]) {
            if (!e[i]) {
              if (!f && cjr) return cjr(i, !0);
              if (cjr) return cjr(i, !0);
...
// keep code in separate functions to avoid deoptimizations & speed loss.
      ...
      6: [ function (_dereq_, module, exports) {
        ...
        module.exports = function resizeFilterGen(quality, srcSize, destSize, scale, offset) {
          ...
          var destPixel, srcPixel, srcFirst, srcLast, filterElementSize, floatFilter, fxpFilter, total, pxl, idx,
            floatVal, filterTotal, filterVal;
